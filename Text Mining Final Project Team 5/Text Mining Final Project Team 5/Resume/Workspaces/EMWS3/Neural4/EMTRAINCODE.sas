...
validdata = EMWS3.TextCluster7_VALIDATE
random=12345
;
nloptions
;
...
train tech=NONE;
code file="C:\Users\lahar\OneDrive\Desktop\Data Mining\Resume\Workspaces\EMWS3\Neural4\SCORECODE.sas"
group=Neural4
;
;
code file="C:\Users\lahar\OneDrive\Desktop\Data Mining\Resume\Workspaces\EMWS3\Neural4\RESIDUALSCORECODE.sas"
group=Neural4
residual
;
;
score data=EMWS3.TextCluster7_TRAIN out=_NULL_
outfit=WORK.FIT1
role=TRAIN
outkey=EMWS3.Neural4_OUTKEY;
score data=EMWS3.TextCluster7_VALIDATE out=_NULL_
outfit=WORK.FIT2
role=VALID
outkey=EMWS3.Neural4_OUTKEY;
score data=EMWS3.TextCluster7_TEST out=_NULL_
outfit=WORK.FIT3
role=TEST
outkey=EMWS3.Neural4_OUTKEY;
run;
