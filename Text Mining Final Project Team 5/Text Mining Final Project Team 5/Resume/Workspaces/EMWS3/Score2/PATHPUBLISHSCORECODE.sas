...
*------------------------------------------------------------*;
_document_ = _n_;
rc=tgscore(resume_str,"termloc.TextFilter2_tmconfig", "termloc.TextFilter2_filtterms", "TextFilter2_out", "&_multifile", 0);
drop rc;
*------------------------------------------------------------*;
* TOOL: Extension Class;
* TYPE: TM;
...
_scrout=work.TextFilter2_out, svd_u=termloc.TextCluster_svd_u, svd_s=termloc.TextCluster_svd_s, prefix=TextCluster);
